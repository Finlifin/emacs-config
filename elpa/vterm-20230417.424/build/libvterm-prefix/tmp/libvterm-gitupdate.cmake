...
function(do_fetch)
  ...
  execute_process(
    COMMAND "/home/fin/.nix-profile/bin/git" --git-dir=.git fetch --tags --force "origin"
...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "/home/fin/.nix-profile/bin/git" --git-dir=.git rev-parse "${ref}^0"
    WORKING_DIRECTORY "/home/fin/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
...
execute_process(
  COMMAND "/home/fin/.nix-profile/bin/git" --git-dir=.git show-ref "64f1775952dbe001e989f2ab679563b54f2fca55"
  WORKING_DIRECTORY "/home/fin/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "/home/fin/.nix-profile/bin/git" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "/home/fin/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "/home/fin/.nix-profile/bin/git" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "/home/fin/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
...
execute_process(
  COMMAND "/home/fin/.nix-profile/bin/git" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "/home/fin/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "/home/fin/.nix-profile/bin/git" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "/home/fin/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "/home/fin/.nix-profile/bin/git" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "/home/fin/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "/home/fin/.nix-profile/bin/git" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "/home/fin/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/home/fin/.nix-profile/bin/git" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "/home/fin/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "/home/fin/.nix-profile/bin/git" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "/home/fin/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: '/home/fin/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm'."
    ...
    execute_process(
      COMMAND "/home/fin/.nix-profile/bin/git" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/home/fin/.nix-profile/bin/git" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "/home/fin/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
    )
    execute_process(
      COMMAND "/home/fin/.nix-profile/bin/git" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "/home/fin/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "/home/fin/.nix-profile/bin/git" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "/home/fin/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
      )
      execute_process(
        COMMAND "/home/fin/.nix-profile/bin/git" --git-dir=.git stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/fin/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
